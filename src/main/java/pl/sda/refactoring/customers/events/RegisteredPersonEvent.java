...
public final class RegisteredPersonEvent implements Event {
    ...
    public RegisteredPersonEvent(UUID id, String email, LocalDateTime createTime, String firstName, String lastName,
